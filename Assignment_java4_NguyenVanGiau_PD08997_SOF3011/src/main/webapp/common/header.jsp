...
<nav class="navbar navbar-expand-lg">
	<div class="container-fluid">
		...
		<img src="<c:url value='templates/user/img/movie.jpg' />" 
		class="img-fluid object-fit-cover" style="width: 37px;height: 35px" alt="Image" /> WatchNet
		</a>
				...
				<c:choose>
					<c:when test="${not empty sessionScope.currentUser}">
						<li class="nav-item"><a class="nav-link nav-link-1 active"
							style="cursor: pointer;" aria-current="page" data-toggle="modal"
							data-target="#changePassModal">Welcom,
...
<div class="tm-hero d-flex justify-content-center align-items-center"
	...
	data-image-src="<c:url value='templates/user/img/about.jpg'/>">
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<div class="form-group">
					<input type="password" name="currentPass" id="currentPass" class="form-control rounded-1"
						placeholder="Current password..." required />
				</div>
				<div class="form-group">
					<input type="password" name="newPass" id="newPass" class="form-control rounded-1"
