			...
			<div class="sidebar">
               ...
               with font-awesome or any other icon font library -->
						...
						<li class="nav-item menu-open"><a
							href="<c:url value='/admin/video?action=view' />" class="nav-link "> <i
								class="nav-icon fas fa-tachometer-alt"></i>
								<p>
					...
					<div class="card-body">
						<div>
							<div class="form-group">
								<label>List Videos</label> <select class="form-select"
									style="height: 50px" aria-label="Default select example"
									id="selectVideo">
